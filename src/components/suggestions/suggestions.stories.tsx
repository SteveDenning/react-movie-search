...
const meta: Meta<typeof Template> = {
  ...
  argTypes: {
    options: {
      ...
      description: "Array of suggested options from displayed from a search input",
    },
    type: {
      control: "text",
      type: { name: "string", required: true },
      description: "Type of media being displayed in the list of options",
    },
  },
};
export default meta;
...
const Suggestions = (args: any) => <Template {...args} />;
